...
function sendMyInfo(socket) {
    $.ajax({
        type: 'get',
        url: 'http://closer-chat.coding.io/getMyInfo',
        success: function(data) {
            socket.emit('sendMyInfo', data, 'chatP');
        },
        error: function(e) {
            console.log(e);
            console.log(e.textStatus);
...
function sendMsg(socket, $editBoxEdit, $editBoxSend) {
    ...
    $editBoxSend.click(function() {
        ...
        function filterData(data) {
            ...
            socket.emit('sendMsg', data, 'chatP', Util.formatDate(new Date(), 'yyyy/mm/dd hh:ii:ss'));
...
checkIsLogin(function(uId, uNickName) {
    ...
    socket.on('connect', function() {
        ...
        socket.emit('join', uId, uNickName, 'chatP');
