...
$.ajax({
    type: 'get',
    url: 'http://closer-chat.coding.io/checkChatEditBox/:cId=' + cId,
        ...
        for (var i = 0; i < data.user.length; i++) {
            ...
            var userInfoPopoverContent = '<p class="user-login-state">当d前：' + (data.user[i].uLoginState === 'down' ? '不' : '') + '在线</p>' +
                                        '<p>' +
                                            ...
                                            '<a href="http://closer-chat.coding.io/user?id=' + data.user[i].uId + '">' + data.user[i].uNickName + '</a></p>' +
            ...
            liTemp.push('<li class="data-toggle" data-toggle="popover" data-content="' + userInfoPopoverContent + '">' +
                            '<img src="http://closer-chat.coding.io' + data.user[i].uImage + '" alt="头像" width="15px" height="15px">&nbsp;' +
            ...
            var attr = ['data-type="chatP"',
                        ...
                        'data-img="http://closer-chat.coding.io' + data.user[i].uImage + '"',
