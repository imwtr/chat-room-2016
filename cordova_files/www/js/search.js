...
function getSearchResult(tag, keyWord) {
    ...
    $.ajax({
        type: 'get',
        url: 'http://closer-chat.coding.io/getSearchResult/:tag=' + tag + '/:w=' + keyWord,
            ...
            for (var i = 0, j = rooms.length; i < j; i++) {     
                ...
                popoverOwnerContent = '<p class="user-login-state">当前：' + (rooms[i].uLoginState === 'down' ? '不' : '') + '在线</p>' +
                                            '<p>' +
                                                ...
                                                '<a href="http://closer-chat.coding.io/user?id=' + rooms[i].rOwnerId + '" data-isFriends="{F' + isFriend + 'F}" style="word-break: break-all;">' + rooms[i].uNickName + '</a></p>' +
                ...
                temp.push('<div class="col-sm-3 col-xs-4">' +
                                '<div class="text-center">' +
                                    ...
                                    '<a data-rId="' + rooms[i].rId + '" href="http://closer-chat.coding.io/room?id=' + rooms[i].rId + '" class="room-logo">' +
                                        '<img src="http://closer-chat.coding.io' + rooms[i].rImage + '" alt="room" width="100%" height="100%">' +
                                    ...
                                    '<div class="caption room-info">' +
                                        '<p>房号: <span class="room-id" data-toggle="popover" data-content="' + popoverIDContent + '"><a href="http://closer-chat.coding.io/room?id=' + rooms[i].rId + '">' + rooms[i].rId + '</a></span></p>' +
